    ...
    <section id="services" className="py-20">
      ...
      <div className="max-w-5xl mx-auto px-4">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10 text-white">
                ...
                >
                  <Link
                    ...
                    className="inline-block bg-turq text-white px-6 py-3 rounded-full shadow-md font-medium transition-all duration-300 hover:bg-turq-shaded hover:shadow-lg transform hover:scale-105"
                  >
                    Learn More
                  </Link>
                </motion.div>
        ...
        <div className="flex justify-center mt-10">
          <Link
            href="/services"
            className="bg-turq text-white px-6 py-3 rounded-full shadow-md font-medium text-lg transition-all duration-300 hover:bg-turq-shaded hover:shadow-lg transform hover:scale-105"
          >
            View All Services
          </Link>
        </div>
